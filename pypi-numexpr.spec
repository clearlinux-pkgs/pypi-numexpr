...
Source0  : https://files.pythonhosted.org/packages/21/67/c7415cf04ebe418193cfd6595ae03e3a64d76dac7b9c010098b39cc7992e/numexpr-2.10.2.tar.gz
...
%prep
%setup -q -n numexpr-2.10.2
cd %{_builddir}/numexpr-2.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732470629
