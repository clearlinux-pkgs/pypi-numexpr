...
Source0  : https://files.pythonhosted.org/packages/d2/8f/2cc977e91adbfbcdb6b49fdb9147e1d1c7566eb2c0c1e737e9a47020b5ca/numexpr-2.11.0.tar.gz
...
%prep
%setup -q -n numexpr-2.11.0
cd %{_builddir}/numexpr-2.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749570401
